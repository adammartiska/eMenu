...
export type DrinksQuery = { __typename?: 'MealsQuery', drinks?: Array<{ __typename?: 'DrinkType', id: number, name: string, price: number, amount: number } | null | undefined> | null | undefined };
...
export type OrderChangedSubscriptionSubscription = { __typename?: 'OrderChangedSubscription', orderChanged?: { __typename?: 'OrderType', id: number, token: string, orderState?: OrderStateEnumType | null | undefined, finalPrice: number, suborders?: Array<{ __typename?: 'SuborderType', meals?: Array<{ __typename?: 'SuborderMealType', id: number, name: string, price: number, count: number } | null | undefined> | null | undefined, drinks?: Array<{ __typename?: 'SuborderDrinkType', id: number, name: string, price: number, count: number } | null | undefined> | null | undefined } | null | undefined> | null | undefined } | null | undefined };
 ...
 * });
 */
export function useOrderChangedSubscriptionSubscription(baseOptions: Apollo.SubscriptionHookOptions<OrderChangedSubscriptionSubscription, OrderChangedSubscriptionSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<OrderChangedSubscriptionSubscription, OrderChangedSubscriptionSubscriptionVariables>(OrderChangedSubscriptionDocument, options);
      }
export type OrderChangedSubscriptionSubscriptionHookResult = ReturnType<typeof useOrderChangedSubscriptionSubscription>;
export type OrderChangedSubscriptionSubscriptionResult = Apollo.SubscriptionResult<OrderChangedSubscriptionSubscription>;